...
public class Framework_001{
	private static final Logger logger = Logger.getLogger(Framework_001.class);
  ...
  public void beforeMethod() throws Exception {
		...
		logger.debug("entering beforeMethod()");
	}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("exiting beforeMethod()");
		}  
        }
  ...
  public void afterMethod() {
	    if (logger.isDebugEnabled()) {
		logger.debug("entering afterMethod()");
	}
	    ...
	    driver.close();
		if (logger.isDebugEnabled()) {
			logger.debug("exiting afterMethod()");
		}
  		}
